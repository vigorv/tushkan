...
class UsersController extends Controller
{
	...
	public function actionAdmin()
	{
		...
		$this->render('/users/admin', array('users' => $users));
	}
	...
	public function actionForm()
	{
		...
		$this->render('/users/form', array('model' => $userForm, 'groups' => $groups));
	}
	...
	public function actionEdit($id = 0)
	{
		...
		$this->render('/users/edit', array('model' => $userForm, 'groups' => $groups, 'info' => $info));
	}
	...
	public function actionSave($id = 0)
	{
		...
		$this->render('/users/save', array('result' => $result));
	}
