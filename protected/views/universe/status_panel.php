...
-->
	...
	<li>
		<a class="btn btn-small" href="#"  onClick="window.open('/universe/uploadui','Uploader','width=700,height=500'); return false;">
    ...
    <li  id="goods" class="dropdown">
		...
		<ul class="dropdown-menu">
			...
			<?php foreach ($partners as $partner): ?>
				<li>  <a class="l_ajax" href="/products/partner/<?php echo $partner['id']; ?>"><?php echo $partner['title']; ?></a></li>
			<?php endforeach; ?>
		</ul></li>
