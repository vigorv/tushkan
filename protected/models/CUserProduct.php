...
class CUserProduct extends CActiveRecord
{
    ...
    public static function findUserProducts($search = '', $user_id = 0, $type_id = -1, $page = 1, $count = 10)
    {
        ...
        return Yii::app()->db->createCommand()
            ->select('tf.title,tf.id, COALESCE(ppv.value,"http://safelib.com/images/films/noposter.jpg") as image,pv.id as variant_id, COALESCE(ppvT.value,"-")  as original_title, COALESCE(ppvG.value,"-")  as genre')
            ->from('{{typedfiles}} tf')
